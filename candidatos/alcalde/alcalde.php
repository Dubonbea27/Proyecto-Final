...
<center>
 ...
 <center><img src="imagenes/img.jpg "></img></center>
       ...
       <center><hgroup><h1>Registrar Candidato a Alcalde</h1><hgroup></center>
     </header>
      <nav id="menu">
 <div id="inicio">
  ...
  <nav>
    <ul>
      <li><a href="manejadorAlcalde.php?accion=con">Modificar</a></li>
        </ul>
  </nav>
</div>
</div>
 ...
 <div class="jumbotron">
 <form action="manejadorAlcalde.php?accion=save" method="post" id="candidato">
 <div id="text">
...
<div class="row">
 ...
 <div class="col-xs-3">
 <select id="municipio"  name ="municipio" class="required form-control" required >
